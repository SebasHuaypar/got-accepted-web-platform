...
import ScholarshipsListClient from "@/components/admin/ScholarshipsListClient";
  ...
  return (
    <div className="space-y-10">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-black text-primary">Scholarships</h1>
          <p className="text-gray-500 text-sm mt-1">
            Manage international, regional, and institutional funding opportunities.
          </p>
        </div>
        <Link
      ...
      <ScholarshipsListClient initialScholarships={scholarships} />
    </div>
  );
}
